...
// 파싱(Parsing): 데이터를 분석해서 원하는 데이터를 추출하는 것
// 파서(Parser): 파싱을 해주는 프로그램
...
public class Ex06 {
	public static void main(String[] args) {
		...
		try {
			...
			// 1. local태그들을 추출한다.(여러개이면 배열에 저장된다)
			...
			for (int i = 0; i < local.getLength(); i++) {
				...
				// 태그의 속성 추출(ta값): ((Element)(local.item(i))).getAttribute("")

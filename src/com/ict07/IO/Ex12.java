...
public class Ex12 {
	public static void main(String[] args) {
		...
		// 읽는 위치
		String pathname1 = "C:"+File.separator+"sammy_study"+File.separator+"util"+File.separator+"java_2.png";
		File read_file = new File(pathname1);
		
		// 쓰는 위치
		String pathname2 = "C:"+File.separator+"sammy_study"+File.separator+"util"+File.separator+"res"+File.separator+"java_2.png";

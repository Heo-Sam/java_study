...
public class Ex07 {
	public static void main(String[] args) {
		...
		// 종류: 고정길이, 가변길이
		// 		 기본 자료형 배열, 참조 자료형 배열로 각각 나뉘어짐
		
		//1. 고정길이 배열
		//	1) 선언: 자료형[][] 이름;
		//	2) 생성: 이름 = new 자료형[1차원 배열의 수][1차원 배열 안에 존재하는 배열의 수];
		//	3) 저장: 이름[index][index] = 데이터; => 고정길이에만 사용할 수 있음
		//			 1차원 배열을 만들어서 다른 배열에 넣기 => 고정,가변 모두 사용 가능
		...
		System.out.println("k1[0] : " + k1[0]); //주소가 저장되어있음
		System.out.println("k1[1] : " + k1[1]);
		
		for (int i = 0; i < k1.length; i++) {
			for (int j = 0; j < k1[i].length; j++) {
				System.out.print(k1[i][j] + " "); //4번 반복수행
			}
			System.out.println();
		}
		System.out.println("======================"); 
		...
		// 선언 생성 데이터 저장 한번에
		int[][] k3 = {{1,2,3,4},{10,20,30,40},{100,200,300,400}}; // k3 = new int[3][4];
		...
		// 1차원 배열을 만들어서 다차원 배열에 넣기 => 고정,가변 모두 사용 가능

...
public class Ex01 {
	public static void main(String[] args) {
		...
		//		 반드시 같은 자료형만 가능
		//		 생성할 때 크기를 지정해야 한다. 배열의 크기는 변경불가
		//		 배열을 출력할 때 일반적으로 for문을 사용한다.
		
		// 배열 생성 순서: 선언 -> 생성 -> 데이터 저장
		// 1. 선언: 자료형[] 배열이름; 또는 자료형 배열이름[];
		// 2. 생성: 배열이름 = new 이름의 자료형[배열의 크기];
		//			배열의 크기는 갯수, 빈 방의 수를 말한다.
		//			new는 메모리에 데이터를 저장할 공간을 만들라는 예약어이다.
		//			다른말로 인스턴스, 객체 생성, 객체화라고 함
		// 3. 저장: 이름[방 번호=index=위치 값] = 데이터;
		...
		// i < 5에서 5는 배열의 크기를 말한다. => su.length
